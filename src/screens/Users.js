        ...
        return <HStack borderColor={colors.PRIMARY_DARK} borderWidth={1} borderRadius={5} p="1" marginY="1">
            ...
            <VStack justifyContent="space-between" space={1} paddingX="1.5" flex={1} >
                <Stack>
                    ...
                    <Text style={globleStyles.cardTextValue} numberOfLines={1}>Parthik Patel</Text>
                </Stack>
                <Stack>
                    <Text style={globleStyles.cardTextLabel}>Phone Number</Text>
                    <Text style={globleStyles.cardTextValue} numberOfLines={1}>+91 959 8980 898</Text>
                </Stack>
                <HStack justifyContent="space-between">
                    <Stack flex={1}>
                        <Text style={globleStyles.cardTextLabel}>Email</Text>
                        <Text style={globleStyles.cardTextValue} numberOfLines={1}>demo9198demo9198@gmail.com</Text>
                    </Stack>
                    <Switch size="md" width={30} height={30} alignSelf={'flex-end'} />
                </HStack>
            </VStack>
